...
export interface DemoNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface DemoNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DemoNFT;
  ...
  mint: TypedContractMethod<[to: AddressLike], [void], "payable">;

  mintForFree: TypedContractMethod<[to: AddressLike], [void], "nonpayable">;
